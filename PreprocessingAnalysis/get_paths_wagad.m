...
filesResponseModels= {'linear_1stlevelprecision_reward_social_config','softmax_social_bias_1stlevelprecision_reward_social_config'};
nameResponseModels= {'linear_1stlevelprecision_reward_social','softmax_social_bias_1stlevelprecision_reward_social'};
