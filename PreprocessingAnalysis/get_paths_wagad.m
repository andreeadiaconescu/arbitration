...
% new models
% filesResponseModels= {'softmax_social_bias_1stlevelprecision_reward_social_config',...
%     'linear_1stlevelprecision_reward_social_config','linear_1stlevelarbitration_reward_social_config'}; % ...
% nameResponseModels= {'softmax_social_bias_1stlevelprecision_reward_social',...
%     'linear_1stlevelprecision_reward_social','linear_1stlevelarbitration_reward_social'};
