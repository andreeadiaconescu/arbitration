...
switch dir1stLevel
    case {'wagad_reversed','wagad_reanalysis','wagad_revision_eLife','wagad_revision','wagad_zscore','wagad_zscore_all','wagad_zscore_difference','wagad_zscore_difference2'}
        switch regressor
            case 'basic_advice'
                iContrast = 1;
            case 'arbitration'
