...
matlabbatch{1}.spm.stats.con.consess{6}.tcon.name = 'Arbitration_UnstableAUnstableR';
matlabbatch{1}.spm.stats.con.consess{6}.tcon.weights = [0 0 0 0 0 1];
matlabbatch{1}.spm.stats.con.consess{6}.tcon.sessrep = 'none';
matlabbatch{1}.spm.stats.con.consess{7}.tcon.name = 'Basic Wager';
