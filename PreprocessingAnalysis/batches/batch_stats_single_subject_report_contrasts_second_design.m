...
matlabbatch{1}.spm.stats.con.consess{10}.tcon.name = 'Cue PE';
...
matlabbatch{1}.spm.stats.con.consess{11}.tcon.name = 'Advice Delta 2';
...
matlabbatch{1}.spm.stats.con.consess{12}.tcon.name = 'Cue Delta 2';
