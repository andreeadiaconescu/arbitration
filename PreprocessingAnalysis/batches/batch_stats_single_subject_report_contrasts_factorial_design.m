...
matlabbatch{1}.spm.stats.con.consess{1}.tcon.name = 'Volatility>Stability'; %
matlabbatch{1}.spm.stats.con.consess{1}.tcon.weights = [-1 1 -1 1];
matlabbatch{1}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{1}.spm.stats.con.consess{2}.tcon.name = 'Main Stability';
...
matlabbatch{1}.spm.stats.con.consess{4}.tcon.name = 'Interaction_Reward';
