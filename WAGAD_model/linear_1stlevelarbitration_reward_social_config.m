...
% Model name
c.model = 'Linear log-wager & choices for binary models';
...
% Model filehandle
c.obs_fun = @linear_1stlevelarbitration_reward_social;

% Handle to function that transforms observation parameters to their native space
% from the space they are estimated in
c.transp_obs_fun = @linear_1stlevelarbitration_reward_social_transp;
