function c = tapas_rw_social_reward_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'tapas_rw_social_reward';
...
% Alpha
c.logital_rmu = tapas_logit(0.25, 1);
c.logital_rsa = 1;

c.logital_amu = tapas_logit(0.25, 1);
c.logital_asa = 1;
...
c.prc_fun = @tapas_rw_social_reward;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @tapas_rw_social_reward_transp;
