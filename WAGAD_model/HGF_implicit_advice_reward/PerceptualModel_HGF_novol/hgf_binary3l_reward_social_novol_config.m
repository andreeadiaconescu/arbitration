function c = hgf_binary3l_reward_social_novol_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%
% In this model, we have double of the trajectories and parameters as we are two quantities 
% over time: the rewards and the advice.    
% Tips:
...
% Model name
c.model = 'hgf_binary3l_reward_social_novol';
...
c.mu3r_0mu = 1;
c.mu3r_0sa = 0; % Free this for voltemp models
c.mu3a_0mu = 1;
c.mu3a_0sa = 0; % Free this for voltemp models
