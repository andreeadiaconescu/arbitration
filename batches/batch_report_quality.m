%-----------------------------------------------------------------------
% Job saved on 04-Jan-2016 19:43:55 by cfg_util (rev $Rev: 6134 $)
% spm SPM - SPM12 (6225)
...
matlabbatch{10}.spm.util.checkreg.data(1) = cfg_dep('Named File Selector: Structural Image(1) - Files', substruct('.','val', '{}',{4}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files', '{}',{1}));
matlabbatch{10}.spm.util.checkreg.data(2) = cfg_dep('Image Calculator: Imcalc Computed Image: mean', substruct('.','val', '{}',{5}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{10}.spm.util.checkreg.data(3) = cfg_dep('Image Calculator: Imcalc Computed Image: sd', substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{10}.spm.util.checkreg.data(4) = cfg_dep('Image Calculator: Imcalc Computed Image: snr', substruct('.','val', '{}',{7}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{10}.spm.util.checkreg.data(5) = cfg_dep('Image Calculator: Imcalc Computed Image: diffOddEven', substruct('.','val', '{}',{8}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{10}.spm.util.checkreg.data(6) = cfg_dep('Image Calculator: Imcalc Computed Image: maxAbsDiff', substruct('.','val', '{}',{9}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{11}.cfg_basicio.file_dir.dir_ops.cfg_cd.dir(1) = cfg_dep('Named Directory Selector: Parent Directory for Quality Report(1)', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','dirs', '{}',{1}));
matlabbatch{12}.spm.util.print.fname = 'report_quality.ps';
matlabbatch{12}.spm.util.print.fig.figname = 'Graphics';
matlabbatch{12}.spm.util.print.opts = 'ps';
