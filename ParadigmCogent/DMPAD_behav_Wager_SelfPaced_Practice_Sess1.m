function SOC = DMPAD_behav_Wager_Practice_Sess1(subject,run,scanner_mode,exp_task,mode_key)
...
if nargin == 0                          % 'nargin' returns the number of parameters specified by the user
    subject = 'DMPAD_Wager_Practice_Sess1';            % if there were no parameters, just use a default subject name
    scanner_mode = 0 ;                  % For the wagering paradigm, leave default scanner_mode=0
    run = 5;                            % For wagering paradigm, leave the default run = 7
    exp_task = 1;                       % Change for practice: practice = 1; task = 2
...
switch language_inst
    case 1
        ...
        cgfont('Arial', 64);
        preparestring('Übung: Aufgabe 1',3,0,250);
        cgfont('Arial', 24);
        preparestring('Bitte sagen Sie vorher, auf welche Seite (Blau oder Grün)',3,0,180);
        preparestring('der Scheibe das Objekt fallen wird.',3,0,140);
        preparestring('Drücken Sie die Taste "N" mit',3,-250,60);
        preparestring('dem rechten Zeigefinger, falls Sie',3,-250,20);
        preparestring ('"BLAU" vorhersagen.',3,-250,-20);   % blue=dominant finger
        preparestring('Drücken Sie die Taste "M" mit',3,250,60);
        ...
        preparestring('- Drücken Sie eine beliebige Taste, um zu beginnen. -',3,0,-120);
        cgfont('Arial', 40);
        preparestring('+',3,0,0);
%         
%         cgfont('Arial', 64);
%         preparestring('Übung',4,0,250);
%         cgfont('Arial', 24);
%         preparestring('Bitte sagen Sie vorher, auf welche Seite (Grün oder Blau)',4,0,180);
%         preparestring('der Scheibe das Objekt fallen wird.',4,0,140);
%         preparestring('Drücken Sie die Taste "N" mit',4,-250,60);
%         preparestring('dem rechten Zeigefinger, falls Sie',4,-250,20);
%         preparestring ('"GRÜN" vorhersagen.',4,-250,-20);   %% green=dominant finger
%         preparestring('Drücken Sie die Taste "M" mit',4,250,60);
%         preparestring('dem rechten Ringfinger, falls Sie',4,250,20);
%         preparestring('"BLAU" vorhersagen.',4,250,-20);      %blue=middle finger
%         preparestring('Drücken Sie eine beliebige Taste, um zu beginnen.',4,0,-80);
...
%         preparestring('+',4,0,0);
        ...
        cgfont('Arial', 64);
        preparestring('Übung: Aufgabe 2',4,0,250);
        cgfont('Arial', 32);
        ...
        preparestring('- Drücken Sie eine beliebige Taste, um zu beginnen. -',4,0,-270);
        cgfont('Arial', 40);
        preparestring('+',4,0,0);
        
        % Instruction for the task
        cgfont('Arial', 64);
        preparestring('Entscheidungsaufgabe',7,0,250);
        cgfont('Arial', 24);
        preparestring('Bitte sagen Sie vorher, auf welche Seite (Blau oder Grün)',7,0,180);
        preparestring('der Scheibe das Objekt fallen wird.',7,0,140);
        preparestring('Drücken Sie die Taste "N" mit',7,-250,60);
        preparestring('dem rechten Zeigefinger, falls Sie',7,-250,20);
        preparestring ('"BLAU" vorhersagen.',7,-250,-20);   % blue=dominant finger
        preparestring('Drücken Sie die Taste "M" mit',7,250,60);
        ...
        cgfont('Arial', 48);
        preparestring('Entscheidungsaufgabe',8,0,250);
        cgfont('Arial', 24);
        preparestring('Bitte sagen Sie vorher, auf welche Seite (Grün oder Blau)',8,0,180);
        preparestring('der Scheibe das Objekt fallen wird.',8,0,140);
        preparestring('Drücken Sie die Taste "N" mit',8,-250,60);
        preparestring('dem rechten Zeigefinger, falls Sie',8,-250,20);
        preparestring ('"GRÜN" vorhersagen.',8,-250,-20);   %% green=dominant finger
        preparestring('Drücken Sie die Taste "M" mit',8,250,60);
...
switch language_inst
    case 1
        ...
        cgfont('Arial', 32);
        preparestring('Mittelfinger "O": zufällig',2,-115,-50);
        preparestring('Zeigefinger "N": hilfreich',2,-110,-90);
        preparestring('Ringfinger "M": irreführend',2,-95,-130);
        ...
        cgfont('Arial', 32);
        preparestring('Mittelfinger "O": zufällig',5,-115,-50);
        preparestring('Zeigefinger "N": hilfreich',5,-110,-90);
        preparestring('Ringfinger "M": irreführend',5,-95,-130);
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    case 2 % main
        switch run
            ...
            case 7 % Adviser for wager
                ...
                SOC.param(exp_task).block_length = [25 25 40 25 25 15 25]; %specify the total number of trials in the 5 blocks
        end
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
switch exp_task
    case 1 % Practice
        ...
        if SOC.mode_key == 1
            ...
            drawpict(5); % Practice with green=dominant finger
        end
        switch scanner_mode
            case 0
                waitkeydown(inf);
...
for block = 1 : SOC.nr_blocksPerSession(exp_task) % given in script
    ...
    for trial = ((block-1)*SOC.param(exp_task).block_length(block))+1:((block-1)*SOC.param(exp_task).block_length(block))+(SOC.param(exp_task).block_length(block)) %number of trials provided in script
        ...
        switch run
            ...
            case 2 % Adviser 3
                ...
                case 5 % Male Adviser 2
                cgopenmovie(41,'a2_blue_1.avi');  % pick blue
                cgopenmovie(42,'a2_green_1.avi');
                cgopenmovie(43,'a2_blue_3.avi');  % pick blue
                cgopenmovie(44,'a2_green_2.avi');
                
                cgopenmovie(45,'a2_blue_5.avi');  % pick blue
                cgopenmovie(46,'a2_green_3.avi');
                cgopenmovie(47,'a2_blue_6.avi');  % pick blue
                cgopenmovie(48,'a2_green_4.avi');
                
                cgopenmovie(49,'a2_blue_7.avi');  % pick blue
                cgopenmovie(50,'a2_green_5.avi');
                cgopenmovie(51,'a2_blue_8.avi');  % pick blue
                cgopenmovie(52,'a2_green_6.avi');
                
                cgopenmovie(53,'a2_blue_9.avi');  % pick blue
                cgopenmovie(54,'a2_green_7.avi');
                cgopenmovie(55,'a2_blue_10.avi');  % pick blue
                cgopenmovie(56,'a2_green_8.avi');
                
                cgopenmovie(57,'a2_blue_11.avi');  % pick blue
                cgopenmovie(58,'a2_green_9.avi');
                cgopenmovie(59,'a2_blue_12.avi');  % pick blue
                cgopenmovie(60,'a2_green_10.avi');
                
                cgopenmovie(61,'a2_blue_13.avi');  % pick blue
                cgopenmovie(62,'a2_green_11.avi');
                cgopenmovie(63,'a2_blue_14.avi');  % pick blue
                cgopenmovie(64,'a2_green_12.avi');
        end
